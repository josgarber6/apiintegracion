...
public class OnlineShopResourceTest {
	...
	public static void setUp() throws Exception {
		...
		shop3 = osr.addOnlineShop(new OnlineShop("Corte Ingles", "https://www.carrefour.es/", "4", "Ahorra con Carrefour online", null));
		shop4 = osr.addOnlineShop(new OnlineShop("Lidl", "https://www.lidl.es/", "5", "�Marca la diferencia!", null));
	...
	public void testGetAll() {
		...
		for (OnlineShop os : shops) {
			System.out.println("Shop " + i++ + " : " + os.getName() + " (ID=" + os.getId() + ")" + " (NAME=" + os.getName() + ")");
		}
	...
	public void testUpdateShop() {
		...
		assertTrue("Error when updating the shop", success);
		
		OnlineShop pl  = osr.getOnlineShop(shop4.getId());
		assertEquals("Theshop's name has not been updated correctly", shopName, pl.getName());
